...
To use ```@ngsl/schematics``` as the default collection in your Angular CLI project, add it to your angular.json, on your command line type: 
...
### Project: 
- Command ```ng g @ngsl/schematics:project```
--- alias: _p_
...
### View Module: 
- Command ```ng g @ngsl/schematics:view-module <name>```
--- alias: _vm_
...
### Shareable Module: 
- Command ```ng g @ngsl/schematics:shareable-module <name>```
--- alias: _sm_
- Creates a shareable module, i. e.modules like Ui, meaning that it's components will be declared and exported

### Interfaces/Enums
- Command ```ng g @ngsl/schematics:(ngsl-interface|ngsl-enum) <name>```
--- alias: _ngsl-i_/_ngsl-e_
- Creates an interface

### Domain Enum
- Command ```ng g @ngsl/schematics:(domain-enum) <name>```
--- alias: _denum_
...
### Observable service
- Command ```ng g @ngsl/schematics:observable-service <name>```
--- alias: _os_
